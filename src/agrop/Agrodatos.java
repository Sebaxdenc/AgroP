...
public class Agrodatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        vergraficajpanel = new agrop.PanelRound();
        ...
        phjpanel5 = new agrop.PanelRound();
        fosforoTXT = new javax.swing.JTextField();
        phjlabel5 = new javax.swing.JLabel();
        phjpanel4 = new agrop.PanelRound();
        ...
        vergraficajlabel.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        arduino.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        fosforoTXT.setFont(new java.awt.Font("Gotham", 0, 14)); // NOI18N
        fosforoTXT.setBorder(null);
        fosforoTXT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fosforoTXTActionPerformed(evt);
            }
        });
        ...
        phjpanel5Layout.setHorizontalGroup(
            ...
            .addGroup(phjpanel5Layout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addComponent(fosforoTXT, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(14, Short.MAX_VALUE))
        );
        phjpanel5Layout.setVerticalGroup(
            ...
            .addGroup(phjpanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(fosforoTXT, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        cerrarSesionLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void nitrogenoTXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nitrogenoTXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nitrogenoTXTActionPerformed

    private void fosforoTXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fosforoTXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fosforoTXTActionPerformed

    private void temperaturaATXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_temperaturaATXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_temperaturaATXTActionPerformed

    private void humedadATXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_humedadATXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_humedadATXTActionPerformed

    private void arduinoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_arduinoMouseExited
        ArduinoJPanel.setBackground(new Color(33,131,128));
    }//GEN-LAST:event_arduinoMouseExited

    private void arduinoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_arduinoMouseEntered
        ArduinoJPanel.setBackground(new Color(0,60,60));
    }//GEN-LAST:event_arduinoMouseEntered

    private void arduinoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_arduinoMouseClicked
       status.setText("");
       ...
       if (puertosDisponibles.length > 0) {
           ...
           puertoArduino.setComPortTimeouts(com.fazecast.jSerialComm.SerialPort.TIMEOUT_READ_SEMI_BLOCKING, 1000, 0);

           // Abrir el puerto
           if (puertoArduino.openPort()) {
               System.out.println("Puerto abierto: " + puertoArduino.getSystemPortName());

               // Crear un hilo para la lectura
               Thread hiloLectura = new Thread(() -> {
                   byte[] buffer = new byte[1024];
                   StringBuilder mensajeCompleto = new StringBuilder();
                   boolean datoLeido = false;

                   try {
                       // Esperar a que el Arduino se estabilice
                       Thread.sleep(2000);

                       // Establecemos un tiempo máximo de espera (10 segundos)
                       long tiempoInicio = System.currentTimeMillis();
                       long tiempoLimite = 10000; // 10 segundos

                       while (!datoLeido && (System.currentTimeMillis() - tiempoInicio < tiempoLimite)) {
                               ...
                               while ((posFinLinea = mensajeCompleto.indexOf("\n")) != -1) {
                                   ...
                                   if (!lineaCompleta.isEmpty()) {
                                       ...
                                       try {
                                           ...
                                           if (datos.length >= 3) {
                                               final String temperaturaA = datos[0];
                                               final String humedadA = datos[1];
                                               final String humedadS = datos[2];

                                               // Guardar en la base de datos en el hilo de la interfaz
                                               javax.swing.SwingUtilities.invokeLater(() -> {
                                                   guardarDatosEnBD(temperaturaA, humedadA, humedadS);
                                               });
                       ...
                       // Cerrar el puerto cuando terminamos
                       if (puertoArduino.isOpen()) {
                           puertoArduino.closePort();
                           System.out.println("Puerto cerrado.");
                       }

                       // Actualizar la interfaz en caso de que no hayamos recibido datos
                       if (!datoLeido) {
                           javax.swing.SwingUtilities.invokeLater(() -> {
                               statusArduino.setText("No se recibieron datos del Arduino");
                           });
                       }
                   }
               });
               ...
               statusArduino.setText("No se pudo conectar al Arduino");
           }
       } else {
           statusArduino.setText("No se encontró Arduino");
       }
   }

   // Método para guardar los datos en la base de datos
   private void guardarDatosEnBD(String temperaturaA, String humedadA, String humedadS) {
       try {
           // Aquí lo que hago es tomar la hora actual de mi pc
           ...
           pst.setString(9, fosforoTXT.getText().trim());
           ...
           statusArduino.setText("El Arduino solo toma TempA, HumA y HumS");
           e.printStackTrace();
       }
   
    }//GEN-LAST:event_arduinoMouseClicked
    ...
    private void temperaturaSTXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_temperaturaSTXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_temperaturaSTXTActionPerformed

    private void humedadSTXTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_humedadSTXTActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_humedadSTXTActionPerformed
    ...
    private void vergraficajlabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_vergraficajlabelMouseExited
        vergraficajpanel.setBackground(new Color(33,131,128));
    }//GEN-LAST:event_vergraficajlabelMouseExited

    private void vergraficajlabelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_vergraficajlabelMouseEntered
        vergraficajpanel.setBackground(new Color(0,60,60));
    }//GEN-LAST:event_vergraficajlabelMouseEntered

    private void vergraficajlabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_vergraficajlabelMouseClicked
        Agrográfica b = new Agrográfica();
        this.setVisible(false);
        b.setVisible(true);
    }//GEN-LAST:event_vergraficajlabelMouseClicked
    ...
    private agrop.PanelRound ArduinoJPanel;
    private agrop.PanelRound CerrarSesionPanel;
    private agrop.PanelRound IngresarJPanel;
    ...
    private javax.swing.JTextField fosforoTXT;
    ...
    private agrop.PanelRound humedadjpanel;
    ...
    private agrop.PanelRound phjpanel;
    private agrop.PanelRound phjpanel1;
    private agrop.PanelRound phjpanel2;
    private agrop.PanelRound phjpanel3;
    private agrop.PanelRound phjpanel4;
    private agrop.PanelRound phjpanel5;
    ...
    private agrop.PanelRound temperaturajpanel;
    private javax.swing.JLabel vergraficajlabel;
    private agrop.PanelRound vergraficajpanel;
